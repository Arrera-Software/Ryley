...
class SettingBETA:
    def __init__(self,windows:Tk,cadre:Frame,config:jsonWork,textColor:str,color:str,linux:bool):
        ...
        btnRetour = [
            Button(self.__acceuilFrame, text="Annuler", bg=color, fg=textColor, font=("arial", "15")),
            Button(self.__tokenGithub, text="Annuler", bg=color, fg=textColor, font=("arial", "15")),
            Button(self.__workFolder, text="Annuler", bg=color, fg=textColor, font=("arial", "15")),
            Button(self.__videoDownload, text="Annuler", bg=color, fg=textColor, font=("arial", "15"))
        ]
