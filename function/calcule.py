...
def Calcule():
    screen = Toplevel()
    calculatriceMenu = Menu(screen,bg=mainTextColor,fg="black",font=("arial","25"))
    ...
    screen.title("Ryley : Calculatrice")
    ...
    def AutreCalcule():
        ...
        labelTheoreme = Label(calc,text="Théorème :",font=("arial","20"),bg=mainColor,fg=mainTextColor)
        labelAutreCal = Label(calc,text="Autre Calcule :",font=("arial","20"),bg=mainColor,fg=mainTextColor)
    ...
    #widget
    #frame
    main = Frame(screen,bg=mainColor,width=700,height=700)
    top = Frame(main,bg=mainColor,width=700,height=175)
    bottom = Frame(main,bg=mainColor,width=700,height=175)
    mainNbComplex = Frame(screen,bg=mainColor,width=700,height=700)
    topNbComplex = Frame(mainNbComplex,bg=mainColor,width=700,height=175)
    bottomNbComplex = Frame(mainNbComplex,bg=mainColor,width=700,height=175)
    #label
    affichage = Label(screen,text="Affichage résultat",font=("arial","25"),bg=mainColor,fg=mainTextColor)
    labeli1 = Label(topNbComplex,text="j",font=("arial","25"),bg=mainColor,fg=mainTextColor)
    labeli2 = Label(bottomNbComplex,text="j",font=("arial","25"),bg=mainColor,fg=mainTextColor)
    #btn
    ...
    #entry
    entryNombre1 = Entry(top,width=40,font=("arial","15"),relief=SOLID)
    entryNombre2 = Entry(bottom,width=40,font=("arial","15"),relief=SOLID)
    entryNombre1NbComplex1 = Entry(topNbComplex,width=15,font=("arial","15"),relief=SOLID)
    entryNombre1NbComplex2 = Entry(topNbComplex,width=15,font=("arial","15"),relief=SOLID)
    entryNombre2NbComplex1 = Entry(bottomNbComplex,width=15,font=("arial","15"),relief=SOLID)
    entryNombre2NbComplex2 = Entry(bottomNbComplex,width=15,font=("arial","15"),relief=SOLID)
    #affichage
    def exitComplex():
