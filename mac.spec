...
# ========= CONFIG À ADAPTER =========
APP_NAME = "ryley"                 # Nom de l'app .app
ENTRY_SCRIPT = "main.py"              # Script d'entrée (contient if __name__ == '__main__')
ICON_ICNS = "asset/macos.icns"                      # Exemple: "assets/icon.icns" (ou laisse None)
BUNDLE_ID = "com.arrera.ryley"   # Identifiant de bundle macOS (optionnel mais conseillé)
